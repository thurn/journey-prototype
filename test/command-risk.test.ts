...
describe("stateless command risk transitions", () => {
  ...
  it("rejects the retired timed window menu shape as unknown", async () => {
    await withTempState(async ({ statePath, options }) => {
  ...
  it("rejects the deleted shared_prefix_menu shape as unknown", async () => {
    await withTempState(async ({ statePath, options }) => {
  ...
  it("rejects the deleted paired_return shape as unknown", async () => {
    await withTempState(async ({ statePath, options }) => {
