...
const MIGRATED_SHAPE_IDS = ["shop_row", "prize_ladder", "single_offer", "heterogeneous_pair", "reward_after_trigger", "take_any_number", "same_reward_different_costs", "random_allocation", "now_vs_later", "shared_prefix_menu", "commit_now_future_payoff", "escalating_reward_chain", "push_your_luck", "random_pool_draws"];
