...
- Lose 120 essence.
- Lose 2 omens.
- Draw 1 fewer card in your opening hand for 3 battles.
...
- After 3 battles, gain 2 copies of {Aspiring Guardian}.
...
- After your next victory, gain {Ginger Root}.

## Played Enough

- After you play {Aspiring Guardian} 5 times, duplicate it.
...
- Roll for 200 essence, {Ginger Root}, or purge 2 chosen cards.
...
- Pay 50 essence. Gain {Ginger Root} after your next victory.
- Gain 1 {Nightmare}. Purge 2 chosen cards after your next victory.
- Purge {Aspiring Guardian}. Gain 2 copies of it after your next victory.

## Deferred Harvest

- Lose 20 essence now. Gain 80 essence at the next dreamscape.
- Gain 1 {Nightmare} now. Gain {Ginger Root} at the next dreamscape.
- Purge a chosen starter card now. Draft 1 of 10 cards at the next dreamscape.

## Locked Promise

- Skip your next {Transfiguration} site. Gain {Ginger Root} after that site.
- Lose your next {Shop} site. Gain {Silver Key} after that site.
...
- {Dreamsign Offering} and {Dreamsign Draft} sites are more common in the next 2
  dreamscapes.
- {Shop} sites are more common in the next 2 dreamscapes.
- {Dream Journey} sites are more common in the next 2 dreamscapes.
