...
| 5 | `alter_dreamscapes` | 6 | Complete | Complete | In progress | Pending | Current |
...
- `alter_dreamscapes` is the active shape.
...
- `alter_dreamscapes` completed migration commit `4ced08f` and audit commit `f0ba652`.
- The active migration target keeps shape-specific code in `src/journey/shapes/alter_dreamscapes/`.
