...
| 7 | `single_random_outcome` | 6 | Complete | Complete | In progress | Pending | Current |
...
- `single_random_outcome` is the active shape.
...
- `single_random_outcome` completed migration commit `8305b41` and audit commit `7e3bb8d`.
- The active migration target keeps shape-specific code in `src/journey/shapes/single_random_outcome/`.
