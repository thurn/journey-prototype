...
| 18 | `single_rule_trial` | 3 | Complete | Complete | In progress | Complete | Current |
...
- `single_rule_trial` is the active shape.
...
- `single_rule_trial` completed migration commit `19cd77d`, and audit commit `d39cd6e`.
- The active migration target keeps shape-specific code in `src/journey/shapes/single_rule_trial/`.
