...
| 17 | `single_offer` | 3 | Complete | Complete | In progress | Complete | Current |
...
- `single_offer` completed migration commit `e50cefb`, and audit commit `7a01663`.
- The active migration target keeps shape-specific code in `src/journey/shapes/single_offer/`.
