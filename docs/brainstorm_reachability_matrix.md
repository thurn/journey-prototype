...
| Borrowed Crown | `organic-return-callback` | late | `reward_after_trigger` | `delayed_hook`, `dreamsign_temporary_grant`, `trigger:each_battle` | `delayed_hook:each_battle`, `reward:dreamsign_temporary_grant` |
...
| Borrowed Crown | temporary grant with return cost | `dreamsign_temporary_grant`, `delayed_hook`, `resource_cost:essence`, `bane_gain`, `card_draft`, `card_purge` | `dreamsign:exact`, `bane:exact`, `card:predicate` | `duration:battle_count`, `trigger:battle` | partial: temporary hook separate | return/dreamsign fixture |
...
| Key Ticket | future trade menu | `dreamsign_gain`, `delayed_hook`, `resource`, `card_gain`, `route_edit:add_site` | `dreamsign:exact`, `card:predicate`, `route_site:exact` | `trigger:future_shop`, `trigger:future_dream_journey`, `duration:battle_count` | partial: delayed hook narrower | return/dreamsign separate |
...
| Returning Lantern | delayed return menu | `delayed_hook`, `dreamsign_gain`, `resource`, `card_purge`, `card_duplicate` | `dreamsign:exact`, `card:chosen_after_commitment` | `trigger:battle`, `duration:battle_count` | partial: delayed hook narrower | return fixture |
