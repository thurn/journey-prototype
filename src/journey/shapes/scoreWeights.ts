...
// to 1 (bottom) across the 33 shapes in the order below — a 10:1 dynamic
// range. Weights are *not* normalized to sum to 100; the actual observed
// share for shape i is roughly `weight(i) / sum(weights) ≈ weight(i) / 177`.
//
