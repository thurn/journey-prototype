...
type GeneratedObjectDefinitionArgs = NaturalGeneratedObjectArgs | {
  kind: GeneratedObjectKind;
  fixture: true;
};
...
function fixtureGeneratedObjectDefinition(
  kind: GeneratedObjectKind,
): GeneratedObjectDefinition {
...
export function generatedObjectDefinition(
  args: GeneratedObjectDefinitionArgs,
): GeneratedObjectDefinition;
export function generatedObjectDefinition(
  args: GeneratedObjectKind | GeneratedObjectDefinitionArgs,
): GeneratedObjectDefinition {
  if (typeof args === "string") {
    return fixtureGeneratedObjectDefinition(args);
  }

  if (args.fixture) {
    return fixtureGeneratedObjectDefinition(args.kind);
  }
